...
from modelos import Carros, Usuarios
...
def index():
    ...
    return render_template("index.html", titulo = 'carro', carros = lista)
...
def criar():
    ...
    #variavel nova recebendo classe carros e filtrando pelo marca
    ...
    #acessando variavel db e o recurso session e adicionando dados a variavel novo carros 
